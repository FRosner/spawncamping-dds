...
pc.autoscale = function() {
  ...
  var defaultScales = {
    ...
    "string": function(k) {
      ...
      // milos: sorting by counts of nominal values
      ...
      // milos: exclude sorting by the counts 
...
pc.commonNomScale = function(global, type) {
  var t = type || "string";
  if (typeof global === 'undefined') {
    global = true;
  }
  ...
  if (global) {
    var domain = scales.map(function(p,i) {
        return yscale[p].domain();
      }).reduce(function(a,b) {
        return a.concat(b);
      });
...
function single_path(d, ctx) {
	__.dimensions.map(function(p, i) {
		if (i == 0) {
      // milos: if statement to check for undefined nominal values
      if (d[p]) {
