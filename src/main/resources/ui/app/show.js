 ...
 *
 *   - clear(): Removes all elements generated by the visualization (NEEDS TO BE IMPLEMENTED BY SUBCLASS)
 */
...
Visualization.prototype.clear = function() {
	console.error("Clear method needs to be implemented when using the Visualization prototype.");
}
